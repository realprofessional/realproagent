...
<!--<li class="task" id="task_li_section{{ $tasksList->id }}" data-index="0" data-board-index="0" draggable="true" ondragstart="">
                                    <div id="task_content_show{{ $tasksList->id }}">
                                        <div class="task-actions">
                                            <button class="btn btn-xs btn-success edit-task" onclick="showEditTaskSection({{ $tasksList->id }});">Edit</button>
                                            <button class="btn btn-xs btn-danger delete-task" onclick="deleteTaskSection({{ $tasksList->id }}, '{{ $tasksList->slug }}');">Delete</button>
                                        </div>
