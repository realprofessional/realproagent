<div class="containers text-center" style="margin-top: 0px; padding-top: 0px;">
    <button class="btn btn-primary pull-right btn_board" id="add_new_board">Add Board</button>
                        ...
                        <ul class="task-items" ondrop="" ondragover="" id="task-ul<?php echo $board->id; ?>">
                            ...
                            if ($tasksLists) {
                                foreach ($tasksLists as $tasksList) {
                                    ?>
                                    <li class="task portlet" id="task_li_section{{ $tasksList->id }}" data-index="0" data-board-index="0" >
                                        <div class="task_med_sec">
    ...
    $(document).ready(function () {
        ...
        $("#add_board_form").validate(
        {
            ...
            submitHandler: function (form) {
                $.ajax({
                    type: 'POST',
                    url: '<?php echo HTTP_PATH; ?>ajax/saveAdminProjectBoard',
