...
<div class="attach_control">
    <?php
    if ($attachmentData) { //echo "<pre>"; print_r($attachmentData);
                ...
                <div class="attachment_left">
                    ...
                    if ($file_ext == "png" || $file_ext == "jpg" || $file_ext == "jpeg" || $file_ext == "gif") {
                        ...
                        if (file_exists(UPLOAD_FULL_ATTACHMENT_IMAGE_PATH . '/' . $attachment->attachment) && $attachment->attachment != "") {
                            ?>
                            {{ Html::image(DISPLAY_FULL_ATTACHMENT_IMAGE_PATH.$attachment->attachment, '', array('alt'=>'Attachment')) }}
                        <?php } else {
                            ?>
    ...
    function deleteAttachment(id) {
            ...
            if (cnfrmm) {
                if (id == '') {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo HTTP_PATH; ?>ajax/deleteAttachment/',
                        data: data,
                        beforeSend: function () {
