...
<div class="text_filedpop_up"> 
    <div class="left_sction">
        ...
        <div class="pop_up_task_desc">
            ...
            <div class="after_show_pop_up_task_desc" style="display: block">
                {{ Form::open(array('id' => 'updatetask'.$taskDetail->id, 'files' => true,'class'=>" pop_form")) }}
                <div class="textareaa">
                    {{ Form::textarea('task_description', $taskDetail->task_description,  array('disabled'=>'disabled',  'rows'=> '2', 'class' => 'required form-control noSpace',  "placeholder"=>"Task Description", "id"=> "update_task_descc".$taskDetail->id)) }}
                                ...
                                <div id="update-section-checbox-value-info{{ $checkBoxesList->id }}">
                                    ...
                                    if ($checkBoxesValueLists) {
                                        foreach ($checkBoxesValueLists as $checkBoxesValueList) {
                                            ...
                                            {{Form::checkbox('is_checked', '1', $varVal, array('disabled'=>'disabled', 'class'=>'required checkbox_clss','id'=>'checkbox_idd_ppup'.$checkBoxesValueList->id))}}
