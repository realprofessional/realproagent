                    ...
                    <td valign="top">
                        ...
                        <table width="100%">
                            ...
                            <?php } if (isset($transaction_id)) { ?>
                                <tr>
                                    <td style="font-size:12px; color:#000; line-height:18px;">
                                        <p style="margin:10px 0 0;"><strong style="width:150px;"> Paypal Transaction Id:</strong>  <?php echo $transaction_id; ?></p>
                                    </td>
                                </tr>
                            <?php } if (isset($shop_name)) { ?>
                                <tr>
                                    <td style="font-size:12px; color:#000; line-height:18px;">
                                        <p style="margin:10px 0 0;"><strong style="width:150px;"> Shop Name:</strong>  <?php echo $shop_name; ?></p>
                                    </td>
                                </tr>
                            <?php } ?>
                                

                            {{ View::make('emails.footer_service_provider')->render() }}
