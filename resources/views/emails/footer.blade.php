        ...
        <table width="100%" style="border-top:1px solid #ddd;">
            <tr>
                <td style="font-size:11px; line-height:18px;">
                    <p style="margin:10px 0 0;color:#000; float: left;"> From <?php echo SITE_TITLE; ?> Team</p>
                    <a style="margin-left:0px; float: right; padding-top: 15px;" href="<?php echo HTTP_PATH; ?>">
    ...
    <tbody style="color: #929292;
        ...
        <tr>
            <td style="font-size:12px;">
                <p style="color:#000;">
                    <?php echo html_entity_decode(Html::link('{{HTTP_PATH}}content/terms_conditions', "Terms and Conditions", array('class' => '', 'title' => "Terms and Conditions"))); ?> | <?php echo html_entity_decode(Html::link('{{HTTP_PATH}}content/privacy_policy', "Privacy Policy", array('class' => '', 'title' => "Privacy Policy"))); ?> | <?php echo html_entity_decode(Html::link('{{HTTP_PATH}}content/about_us', "About Us", array('class' => '', 'title' => "About Us"))); ?> <br/>
                    Copyright &copy; <?php echo date('Y'); ?>  <a style="color:#000;" href="<?php echo HTTP_PATH ?>"> www.realproagent.com</a> All Rights Reserved.</p>
            </td>
        </tr>
    </tbody>
</table>
