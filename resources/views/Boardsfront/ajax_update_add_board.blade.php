<div id="board_{{ $board->id }}" class="board-wrap" data-board-id="<?php echo $board->id; ?>"  data-board-position="<?php echo $board->board_position; ?>">
    ...
    <ul class="task-items" ondrop="" ondragover="" id="task-ul<?php echo $board->id; ?>"  data-ul-board-id="<?php echo $board->id; ?>">
