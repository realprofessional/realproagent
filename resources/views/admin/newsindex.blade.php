@section('title', 'Administrator :: '.TITLE_FOR_PAGES.'News List')
            ...
            <div class="col-lg-12">
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        {{ Form::open(array('url' => 'admin/newsList', 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>'form-inline')) }}
                        ...
                        <span class="hint" style="margin:5px 0">Search News by typing their title.</span>
...
jQuery(document).ready(function(){
    ...
    jQuery('.reset_form').click(function(){
       ...
       window.location.href= '<?php echo HTTP_PATH; ?>admin/newsList'; 
