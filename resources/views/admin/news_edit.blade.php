@section('title', 'Administrator :: '.TITLE_FOR_PAGES.'Edit News')
            ...
            <div class="col-lg-12">
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        {{ Form::model($detail,array('url' => 'admin/newsList/edit/'.$detail->slug, 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>"cmxform form-horizontal tasi-form form")) }}
...
<div class="form-group">
                        ...
                        <?php if (file_exists(UPLOAD_FULL_NEWS_IMAGE_PATH . '/' . $detail->upload_image) && $detail->upload_image != "") { ?>
                            <div class="form-group">
                                {{  Form::label('old_image', 'Current Image',array('class'=>"control-label col-lg-2")) }}
                                <div class="col-lg-10">
                                    {{ Html::image(UPLOAD_FULL_NEWS_IMAGE_PATH.$detail->upload_image, '', array('width' => '100px')) }}
                                </div>
                            </div>
                        <?php } ?>
