                        ...
                        <table class="table table-bordered table-striped table-condensed cf">
                            <thead class="cf">
                                <tr>
                                    ...
                                    <th>@sortablelink('approve_status', 'Approval Status')</th>
                                ...
                                foreach ($users as $user) {
                                    ...
                                    <tr>
                                        ...
                                        <td data-title="Action">
                                            <?php
                                            if (!$user->status)
                                                echo html_entity_decode(Html::link('admin/customer/Admin_activeuser/' . $user->slug, '<i class="fa fa-check"></i>', array('class' => 'btn btn-success btn-xs action-list', 'title' => "Active", 'onclick' => "return confirmAction('activate');")));
                                            else
                                                echo html_entity_decode(Html::link('admin/customer/Admin_deactiveuser/' . $user->slug, '<i class="fa fa-check"></i>', array('class' => 'btn btn-danger btn-xs action-list', 'title' => "Deactive", 'onclick' => "return confirmAction('deactive');")));
