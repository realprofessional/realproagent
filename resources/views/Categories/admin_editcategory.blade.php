            ...
            <div class="col-lg-12">
                <ul id="breadcrumb" class="breadcrumb">
                    ...
                    <li>
                        ...
                        {{ html_entity_decode(Html::link(HTTP_PATH.'admin/categories/admin_index', "Categories", array('id' => ''), true)) }}
                    </li>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        {{ Form::model($detail, array('url' => '/admin/categories/Admin_editcategory/'.$detail->slug, 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>"cmxform form-horizontal tasi-form form")) }}
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                ...
                                {{ html_entity_decode(Html::link(HTTP_PATH.'admin/categories/admin_index', "Cancel", array('class' => 'btn btn-default'), true)) }}
                            </div>
                        </div>
