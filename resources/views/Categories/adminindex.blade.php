        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul id="breadcrumb" class="breadcrumb">
                    ...
                    <li>
                        <i class="fa fa-cutlery"></i> Categories </li>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        {{ Form::open(array('url' => 'admin/categories/admin_index', 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>'form-inline')) }}
