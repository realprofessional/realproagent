@section('title', 'Administrator :: '.TITLE_FOR_PAGES.'Categories List')
...
<section id="main-content">
    <section class="wrapper">
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul id="breadcrumb" class="breadcrumb">
                    ...
                    <li>
                        <i class="fa fa-building-o"></i> Categories </li>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        {{ Form::open(array('url' => 'user/categories/admin_index', 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>'form-inline')) }}
                        ...
                        <span class="hint" style="margin:5px 0">Search Category by typing their name</span>
                        <!--                        <div class="form-group align_box">
                                                    <div class="clr"></div>
        ...
        <div id="middle-content">
            @include('Categories/user_ajax_index')
        </div>
    </section>
</section>
