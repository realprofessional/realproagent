@section('title', 'Administrator :: '.TITLE_FOR_PAGES.'User Type List')
        ...
        <div class="row">
            <div class="col-lg-12">
                <ul id="breadcrumb" class="breadcrumb">
                    ...
                    <li>
                        <i class="fa fa-credit-card"></i> User Type
                    </li>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        {{ Form::open(array('url' => 'admin/usertype/list', 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>'form-inline')) }}
                        ...
                        <span class="hint" style="margin:5px 0">Search User Type by keyword</span>
...
jQuery(document).ready(function(){
    jQuery('.reset_form').click(function(){
       window.location.href= '<?php echo HTTP_PATH; ?>admin/usertype/list'; 
    });
});
</script>
@stop