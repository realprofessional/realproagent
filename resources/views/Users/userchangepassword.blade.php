            ...
            <div class="col-lg-12">
                ...
                <section class="panel">
                    ...
                    <div class="panel-body"> 
                        ...
                        <div class=" form">
                            <?php echo Form::open(array('url' => 'user/changepassword', 'method' => 'post', 'id' => 'myform', 'class' => 'cmxform form-horizontal tasi-form form')); ?>
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                    ...
                                    <a class="btn btn-default" href="<?php echo HTTP_PATH . "user/dashboard" ?>">Cancel</a>
                                </div>
                            </div>
                            <?php echo Form::close(); ?>
                        </div>
