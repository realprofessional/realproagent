        ...
        <div class="row state-overview">
            <div class="col-lg-3 col-sm-6">
                <section class="panel">
                    ...
                    <div class="value">
                        <h1 class="count">
<!--                            {{ $user = DB::table('users')->where('user_type', "=", "Hotel Owner")->count()  }}-->
                        </h1>
                        <p>{{ link_to('/admin/user/userlist', "Hotels", array('escape' => false,'class'=>"")) }}</p>
                    </div>
                </section>
            </div>
...
<!--            <div class="col-lg-3 col-sm-6">
                <section class="panel">
                    ...
                    <div class="value">
                        <h1 class=" count3">
                      {{ $user_customer = DB::table('users')->where('user_type', "=", "Customer")->count()  }}       
                            {{ $pages= DB::table('pages')->count()  }}
                        </h1>
                        <p>{{ link_to('/admin/customer/admin_index', "Customer", array('escape' => false,'class'=>"")) }}</p>
                    </div>
                </section>
            </div>-->
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Hotel Registrations ( {{0}} new Hotel registered in the last 7 days )
                        </header>
