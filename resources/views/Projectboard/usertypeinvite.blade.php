                    ...
                    <div class="user_dashboards_top_tab">
                        <ul>
                            ...
                            if ($usertypes) {
                                foreach ($usertypes as $usertype) {
                                    ?>
                                    <li class="<?php if($usertypesData->id == $usertype->id){ echo "active"; }?>"><a href="<?php echo HTTP_PATH; ?>boards/<?php echo $usertype->slug ?>/<?php echo $project->slug; ?>/<?php echo $boardData->slug; ?>"><?php echo $usertype->type ?></a></li>
                                    <?php
                                }
                            }
                            ?>
