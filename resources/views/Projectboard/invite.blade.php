        ...
        <nav class="breadcrumbs">
            <div class="container">
                <ul>
                    ...
                    <li class="breadcrumbs__item">
                        <span><a href="{{HTTP_PATH}}board/{{$project->slug}}/{{$boardData->slug}}">{{$boardData->board_name}}</a></span>
                    </li>
                </ul>
            </div>
        </nav>
                ...
                <div class="user_dashboards_top">
                    <div class="us_serh">
                        <div class="left_forms">
                            {{ Form::open(array('url' => 'board/invite/'.$project->slug.'/'.$boardData->slug, 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>'form-inline')) }}
                            ...
                            <div class="us_serh_bx">
                                ...
                                <div class="user_selecl">
                                    ...
                                    foreach ($usertypes as $usertype) {
                                        $userTypeArray[$usertype->id] = ucwords($usertype->type);
                                    }
                                    ?>
                                    <span>
                                ...
                                <input type="hidden" id="" name="board_id" value="<?php echo $boardData->id ?>">
                    ...
                    <div class="user_dashboards_top_tab">
                        <ul>
                            <li class="active"><a href="<?php echo HTTP_PATH; ?>board/invite/<?php echo $project->slug; ?>/<?php echo $boardData->slug; ?>">All User</a></li>
                            <?php
                            if ($usertypes) {
                                foreach ($usertypes as $usertype) {
                                    ?>
                                    <li><a href="<?php echo HTTP_PATH; ?>boards/<?php echo $usertype->slug ?>/<?php echo $project->slug; ?>/<?php echo $boardData->slug; ?>"><?php echo $usertype->type ?></a></li>
                                    <?php
                                }
                            }
                            ?>
                                        ...
                                        <div class="user_list_bx">
                                            ...
                                            <div class="user_nwe_bx">
                                                <div class="user_nwe_bx_rop">
                                                    ...
                                                    <p>
                                                        <?php
                                                        $usertypeData = DB::table('usertypes')
                                                                ->where('status', 1)
                                                                ->orderby('created', 'ASC')
                                                                ->get();
                                                ...
                                                <div class="add_secctt">
                                                    <?php echo $user->address . " " . $user->address2 ?>
                                                </div>
                                                <div class="company_secctt">
