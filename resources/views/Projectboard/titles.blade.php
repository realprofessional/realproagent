                ...
                <div class="user_dashboards_top">
                    ...
                    <div class="us_serh">
                        ...
                        <div class="left_forms">
                            {{ Form::open(array('url' => 'board/title/'.$project->slug, 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>'form-inline')) }}
                    ...
                    <div class="user_dashboards_top_tab">
                        <ul>
                            ...
                            <li class="active"><a href="<?php echo HTTP_PATH; ?>board/title/<?php echo $project->slug; ?>/<?php echo $boardData->slug; ?>">Title</a></li>
