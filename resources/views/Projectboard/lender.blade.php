                ...
                <div class="user_dashboards_top">
                    <div class="us_serh">
                        ...
                        <div class="left_forms">
                            {{ Form::open(array('url' => 'board/lender/'.$project->slug, 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>'form-inline')) }}
                    ...
                    <div class="user_dashboards_top_tab">
                        <ul>
                            ...
                            <li><a href="<?php echo HTTP_PATH; ?>board/agent/<?php echo $project->slug; ?>/<?php echo $boardData->slug; ?>">Agents</a></li>
                            <li class="active"><a href="<?php echo HTTP_PATH; ?>board/lender/<?php echo $project->slug; ?>/<?php echo $boardData->slug; ?>">Lenders</a></li>
