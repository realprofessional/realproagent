...
<section id="main-content">
    <section class="wrapper">
        <div class="row">
            <div class="col-lg-12">
                <ul id="breadcrumb" class="breadcrumb">
                    ...
                    <li>
                        <i class="fa fa-credit-card"></i> Transaction Type
                    </li>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        {{ Form::open(array('url' => 'admin/transaction/list', 'method' => 'post', 'id' => 'adminAdd', 'files' => true,'class'=>'form-inline')) }}
                        ...
                        <span class="hint" style="margin:5px 0">Search Transaction Type by keyword</span>
        ...
        <div id="middle-content">
            @include('Transaction/ajax_index')
        </div>
    </section>
</section>
