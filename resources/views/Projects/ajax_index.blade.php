...
if (!$projects->isEmpty()) {
    ...
    <!--                                    <th>@sortablelink('users.first_name', 'Project Manager')</th>-->
                                    ...
                                    <th>@sortablelink('transaction', 'Transaction')</th>
    ...
    <!--                                    <th>Created</th>-->
                                ...
                                foreach ($projects as $project) {
                                    ...
                                    <tr>
                                        ...
                                        <td data-title="Transaction">
                                            {{ ucwords($project->transaction == 0 ? "Buyer Transaction" : "Seller Transaction"); }}
                                        </td>
                                        <td data-title="Transaction Amount">
                                            ${{  $project->transaction_amount ? $project->transaction_amount : "0.00"; }}
                                        </td>
                                        <td data-title="Transaction Type">
                                            ...
                                            if ($project->transaction_type > 0) {
                                                ...
                                                {{ ucwords($transactions->type ? $transactions->type :  "N/A"); }}
            ...
            echo html_entity_decode(Html::link('admin/projects/inviteUser/' . $project->slug, '<i class="fa fa-user"></i>', array('title' => 'Invite Users', 'class' => 'btn btn-primary btn-xs action-list delete-list', 'escape' => false)));
            ?>
                                            </td>	
                                        </tr>
                                                <?php
