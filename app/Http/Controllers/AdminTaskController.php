...
class AdminTaskController extends BaseController {
    /*
      |--------------------------------------------------------------------------
    ...
    public function showAdmin_index() {         //Admin Task Listing
    ...
    function showAdmin_saveAdminBoard() {
        if (!Session::has('adminid')) {
            return Redirect::to('/admin/login');
        }
