...
/* * * define constants ** */
define('SITE_TITLE', 'Task Management');
define('SITE_URL', 'taskmanagement.com');
define('TAG_LINE', 'Task Managment');
define('MAIL_FROM', 'taskmanagement.com');
define('TITLE_FOR_PAGES', SITE_TITLE . " :: ");

define('HTTP_PATH', "http://demo.imagetowebpage.com/task_management/");
define("BASE_PATH", $_SERVER['DOCUMENT_ROOT'] . "/task_management");
